...
class Register:
    def __init__(self, helper: Helper, db: Database, username: str, password: str, email: str, contact: str,
...
"""
    ...
    def creation(self, username: str, email: str, hash_password: str, country_code: str, contact: str):
        self.db.insert(list_of_keys=['username', 'password', 'email', 'country_code', 'contact_number'],
                       list_of_values=[username, hash_password, email, country_code, contact],
